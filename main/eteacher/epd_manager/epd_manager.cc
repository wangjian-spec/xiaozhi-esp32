...
namespace
{
    ...
    static EpdRenderer::FontPt ToFontPt(int pt)
    {
        ...
        {
        case 9:
            return EpdRenderer::FontPt::k9;
        case 10:
            return EpdRenderer::FontPt::k10;
        case 11:
            return EpdRenderer::FontPt::k11;
        case 12:
            return EpdRenderer::FontPt::k12;
        case 13:
            return EpdRenderer::FontPt::k13;
        default:
            return EpdRenderer::FontPt::k11;
        }
    }
    ...
    static void MetricsForWenquanyiPt(EpdRenderer::FontPt font_pt, int &out_chinese_width, int &out_ascii_width, int &out_line_height)
    {
        ...
        switch (font_pt)
        {
        case EpdRenderer::FontPt::k9:
            w = 12;
            h = 14;
            break;
        case EpdRenderer::FontPt::k10:
            w = 13;
            h = 14;
            break;
        case EpdRenderer::FontPt::k11:
            w = 16;
            h = 18;
            break;
        case EpdRenderer::FontPt::k12:
            w = 16;
            h = 19;
            break;
        case EpdRenderer::FontPt::k13:
            w = 14;
            h = 15;
            break;
        default:
