...
static const app_ui::desc::WidgetDesc kScene_page_f3a5_widgets[] = {
    ...
    { 0x8F5C97CEu, 0x5E9C722Fu, app_ui::WidgetType::TextArea, {146, 30, 120, 40}, app_ui::kInvalidStyleId, app_ui::desc::kWidgetFlagVisible | app_ui::desc::kWidgetFlagEnabled | app_ui::desc::kWidgetFlagFocusable, 3, &kText_page_f3a5_textarea_dd2b8b },
    { 0x1DCE2948u, 0x5E9C722Fu, app_ui::WidgetType::Label, {44, 29, 80, 40}, app_ui::kInvalidStyleId, app_ui::desc::kWidgetFlagVisible | app_ui::desc::kWidgetFlagEnabled, 1, &kText_page_f3a5_label_8ba487 },
    { 0xFD7E1ABFu, 0x5E9C722Fu, app_ui::WidgetType::Frame, {10, 78, 380, 200}, app_ui::kInvalidStyleId, app_ui::desc::kWidgetFlagVisible | app_ui::desc::kWidgetFlagEnabled, 1, &kText_page_f3a5_frame_e86a40 },
};
...
static const app_ui::desc::WidgetDesc kScene_public_widgets[] = {
    ...
    { 0x5AF83D98u, 0xDE440657u, app_ui::WidgetType::SoftKeyboard, {50, 184, 300, 100}, app_ui::kInvalidStyleId, app_ui::desc::kWidgetFlagVisible | app_ui::desc::kWidgetFlagEnabled, 0, nullptr },
};
