...
enum EteacherAecMode {
    kEteacherAecOff,
    kEteacherAecOnDeviceSide,
    kEteacherAecOnServerSide,
};
...
public:
    ...
    EteacherState GetDeviceState() const { return state_machine_.GetState(); }
     ...
     */
    bool SetDeviceState(EteacherState state);
...
private:
    ...
    EteacherStateMachine state_machine_;
    ListeningMode listening_mode_ = kListeningModeAutoStop;
    EteacherAecMode aec_mode_ = kEteacherAecOff;
    ...
    void OnStateChanged(EteacherState old_state, EteacherState new_state);
};


class EteacherTaskPriorityReset {
public:
    EteacherTaskPriorityReset(BaseType_t priority) {
        original_priority_ = uxTaskPriorityGet(NULL);
        vTaskPrioritySet(NULL, priority);
    }
    ~EteacherTaskPriorityReset() {
...
#endif // _ETEACHER_APP_SERVICE_H_
