#ifndef ETEACHER_MCP_SERVER_H
#define ETEACHER_MCP_SERVER_H
...
class EteacherMcpServer {
public:
    static EteacherMcpServer& GetInstance() {
        static EteacherMcpServer instance;
        return instance;
    }
