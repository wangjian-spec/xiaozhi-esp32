...
CustomWifiBoard::CustomWifiBoard() {
...
std::string CustomWifiBoard::GetBoardType() {
    return "wifi";
}

void CustomWifiBoard::StartNetwork() {
...
void CustomWifiBoard::TryWifiConnect() {
...
void CustomWifiBoard::OnNetworkEvent(NetworkEvent event, const std::string& data) {
    switch (event) {
...
void CustomWifiBoard::SetNetworkEventCallback(NetworkEventCallback callback) {
    network_event_callback_ = std::move(callback);
}

void CustomWifiBoard::OnWifiConnectTimeout(void* arg) {
    auto* board = static_cast<CustomWifiBoard*>(arg);
...
void CustomWifiBoard::StartWifiConfigMode() {
    in_config_mode_ = true;
...
void CustomWifiBoard::EnterWifiConfigMode() {
...
bool CustomWifiBoard::IsInWifiConfigMode() const {
    return WifiManager::GetInstance().IsConfigMode();
}

NetworkInterface* CustomWifiBoard::GetNetwork() {
    static EspNetwork network;
    return &network;
}

const char* CustomWifiBoard::GetNetworkStateIcon() {
    auto& wifi = WifiManager::GetInstance();
...
std::string CustomWifiBoard::GetBoardJson() {
    auto& wifi = WifiManager::GetInstance();
...
void CustomWifiBoard::SetPowerSaveLevel(PowerSaveLevel level) {
...
std::string CustomWifiBoard::GetDeviceStatusJson() {
